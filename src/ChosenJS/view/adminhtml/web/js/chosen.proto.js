...
(function () {
  ...
  AbstractChosen = (function () {
    ...
    AbstractChosen.prototype.set_default_text = function () {
      ...
      return (this.results_none_found =
        this.form_field.getAttribute("data-no_results_text") || this.options.no_results_text || AbstractChosen.default_no_result_text);
    };
  ...
  this.Chosen = (function (superClass) {
    ...
    Chosen.prototype.register_observers = function () {
      ...
      if (this.is_multiple) {
        return this.search_choices.observe(
          "click",
          (function (_this) {
            return function (evt) {
