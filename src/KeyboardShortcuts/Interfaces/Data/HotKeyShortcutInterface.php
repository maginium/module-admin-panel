...
namespace Maginium\AdminKeyboardShortcuts\Interfaces\Data;

use Maginium\Framework\Support\Collection;

/**
 * HotKeyShortcutInterface.
 *
 * Defines the contract for the HotKeyShortcut model, specifying the methods that
 * must be implemented for managing admin hot key shortcuts.
 *
 ...
 */
interface HotKeyShortcutInterface
{
}
