...
!(function (e, t) {
  ...
  function h(t, e) {
    ...
    for (let e = 0; e < n.length; e++) n[e] = t[n[e].toLowerCase()];
    return n;
  }
  function m(e) {
  ...
  const o = {
    ...
    v = {};
  for (let e = 1; e < 20; e++) o["f".concat(e)] = 111 + e;
  let w = [],
    O = null,
    t = "all";
  const b = new Map(),
  ...
  function x(n) {
    if (void 0 === n)
      Object.keys(v).forEach((e) => {
        Array.isArray(v[e]) && v[e].forEach((e) => s(e)), delete v[e];
      }),
        c(null);
    ...
    else if ("object" == typeof n) n.key && s(n);
    else if ("string" == typeof n) {
      for (var o = arguments.length, r = Array(1 < o ? o - 1 : 0), i = 1; i < o; i++) r[i - 1] = arguments[i];
      let [e, t] = r;
      "function" == typeof e && ((t = e), (e = "")), s({ key: n, scope: e, method: t, splitKey: "+" });
    }
  }
  const s = (e) => {
        ...
        (v[n] = v[n].filter((e) => {
          var t =
            ...
            (function (e, t) {
              ...
              let r = !0;
              for (let e = 0; e < n.length; e++) ~o.indexOf(n[e]) || (r = !1);
              return r;
            })(e.mods, o);
          return t && r.push(e.element), !t;
        })),
          r.forEach((e) => c(e));
      }
    });
  ...
  function j(t, n, o, e) {
    if (n.element === e) {
      ...
      if (n.scope === o || "all" === n.scope) {
        ...
        ((0 !== n.mods.length || g[16] || g[18] || g[17] || g[91]) && !e && "*" !== n.shortcut) ||
          ((n.keys = []),
        ...
        ["ctrlKey", "altKey", "shiftKey", "metaKey"].forEach((e) => {
          ...
          n[e] && !~w.indexOf(t)
            ...
            : !n[e] && ~w.indexOf(t)
              ...
              : "metaKey" !== e || !n[e] || 3 !== w.length || n.ctrlKey || n.shiftKey || n.altKey || (w = w.slice(w.indexOf(t)));
        }),
        e in g)
      ) {
        g[e] = !0;
        for (const d in k) k[d] === e && (L[d] = !0);
        if (!o) return;
      }
      for (const u in g) Object.prototype.hasOwnProperty.call(g, u) && (g[u] = n[p[u]]);
      n.getModifierState &&
        (!n.altKey || n.ctrlKey) &&
        n.getModifierState("AltGraph") &&
        (~w.indexOf(17) || w.push(17), ~w.indexOf(18) || w.push(18), (g[17] = !0), (g[18] = !0));
      var r = K();
      if (o)
        for (let e = 0; e < o.length; e++)
          o[e].scope === r && (("keydown" === n.type && o[e].keydown) || ("keyup" === n.type && o[e].keyup)) && j(n, o[e], r, t);
      if (e in v) {
        var i = v[e],
          l = i.length;
        for (let e = 0; e < l; e++)
          if ((("keydown" === n.type && i[e].keydown) || ("keyup" === n.type && i[e].keyup)) && i[e].key) {
            var s = i[e],
              ...
              a = s.key.split(c),
              f = [];
            for (let e = 0; e < a.length; e++) f.push(E(a[e]));
            f.sort().join("") === w.sort().join("") && j(n, s, r, t);
          }
      }
    }
  }
      ...
      (b.has(s) ||
        ...
        (o = function () {
          ...
          C(t, s);
          {
            ...
            var n = w.indexOf(e);
            if (
              (n < 0 || w.splice(n, 1), t.key && "meta" == t.key.toLowerCase() && w.splice(0, w.length), (e = 93 !== e && 224 !== e ? e : 91) in g)
            ) {
              g[e] = !1;
              for (const o in k) k[o] === e && (L[o] = !1);
            }
          }
        }),
        b.set(s, { keydownListener: t, keyupListenr: o, capture: u }),
        y(s, "keydown", t, u),
        y(s, "keyup", o, u)),
      O ||
        ((t = () => {
  ...
  function c(t) {
    var e,
      n,
      o,
      r = Object.values(v).flat();
    r.findIndex((e) => {
      e = e.element;
      return e === t;
    }) < 0 &&
      (({ keydownListener: o, keyupListenr: n, capture: e } = b.get(t) || {}), o) &&
      n &&
      (i(t, "keyup", n, e), i(t, "keydown", o, e), b.delete(t)),
      (0 < r.length && 0 < b.size) ||
        (Object.keys(b).forEach((e) => {
          var { keydownListener: t, keyupListenr: n, capture: o } = b.get(e) || {};
          t && n && (i(e, "keyup", n, o), i(e, "keydown", t, o), b.delete(e));
        }),
        b.clear(),
        Object.keys(v).forEach((e) => delete v[e]),
        O && (({ listener: n, capture: o } = O), i(window, "focus", n, o), (O = null)));
  }
  var n = {
    getPressedKeyString: function () {
      return w.map((e) => {
        return (n = e), Object.keys(o).find((e) => o[e] === n) || ((t = e), Object.keys(k).find((e) => k[e] === t)) || String.fromCharCode(e);
        var t, n;
      });
    },
    setScope: l,
  ...
  for (const r in n) Object.prototype.hasOwnProperty.call(n, r) && (L[r] = n[r]);
  if ("undefined" != typeof window) {
    const a = window.hotkeys;
    (L.noConflict = (e) => (e && window.hotkeys === L && (window.hotkeys = a), L)), (window.hotkeys = L);
  }
  return L;
});
