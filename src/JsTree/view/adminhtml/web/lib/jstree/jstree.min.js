  ...
  if (!e.jstree) {
    ...
    !c &&
      ...
      (e.jstree.reference = function (t) {
        var i = null,
          r = null;
        if ((!t || !t.id || (t.tagName && t.nodeType) || (t = t.id), !r || !r.length))
          try {
            r = e(t);
          } catch (e) {}
        if (!r || !r.length)
        ...
        return (
          r && r.length && (r = r.closest(".jstree")).length && (r = r.data("jstree"))
            ? (i = r)
      ...
      (e.jstree.defaults.core = {
        ...
        keyboard: {
          ...
          right: function (t) {
            if ((t.preventDefault(), this.is_closed(t.currentTarget)))
      ...
      (e.jstree.core.prototype = {
        ...
        _create_prototype_node: function () {
          ...
          return (
            ...
            (e = d.createElement("I")),
            (e.className = "jstree-icon jstree-ocl"),
            e.setAttribute("role", "presentation"),
            i.appendChild(e),
            (e = d.createElement("A")),
            (e.className = "jstree-anchor"),
            e.setAttribute("href", "#"),
            e.setAttribute("tabindex", "-1"),
            e.setAttribute("role", "treeitem"),
            (t = d.createElement("I")),
            (t.className = "jstree-icon jstree-themeicon"),
        ...
        _kbevent_to_func: function (e) {
          ...
          if (
            ...
            "shift-shift" === i || "ctrl-ctrl" === i || "alt-alt" === i)
          )
            return null;
          var r,
            s,
            a = this.settings.core.keyboard;
          for (r in a)
            if (
              a.hasOwnProperty(r) &&
              ((s = r),
              "-" !== s &&
                "+" !== s &&
                ((s = s.replace("--", "-MINUS").replace("+-", "-MINUS").replace("++", "-PLUS").replace("-+", "-PLUS")),
                (s = s.split(/-|\+/).sort().join("-").replace("MINUS", "-").replace("PLUS", "+").toLowerCase())),
              s === i)
            )
              return a[r];
          return null;
        ...
        bind: function () {
          ...
          this.element
            ...
            .on(
              ...
              e.proxy(function (e) {
                return (
                  !(!e.target.tagName || "input" !== e.target.tagName.toLowerCase()) ||
                  void (this.settings.core.dblclick_toggle && this.toggle_node(e.target))
                );
              }, this),
            )
            .on(
                          ...
                          if (((this._data.core.ready = !0), this._data.core.selected.length)) {
                            if (this.settings.core.expand_selected_onload) {
                              var t,
                                i,
                                r = [];
                              for (t = 0, i = this._data.core.selected.length; i > t; t++)
        ...
        get_node: function (t, i) {
          ...
          try {
            if (this._model.data[t]) t = this._model.data[t];
              ...
              "string" == typeof t &&
              (r = e("#" + t.replace(e.jstree.idregex, "\\$&"), this.element)).length &&
              this._model.data[r.closest(".jstree-node").attr("id")]
            )
        ...
        get_path: function (t, i, r) {
          ...
          var s,
            a,
            n = [];
          for (n.push(r ? t.id : t.text), s = 0, a = t.parents.length; a > s; s++) n.push(r ? t.parents[s] : this.get_text(t.parents[s]));
        ...
        get_prev_dom: function (t, i) {
          ...
          return (r = t[0].parentNode.parentNode), !(!r || !r.className || -1 === r.className.indexOf("jstree-node")) && e(r);
        },
        get_parent: function (t) {
          return (t = this.get_node(t)), !(!t || t.id === e.jstree.root) && t.parent;
        },
        get_children_dom: function (e) {
          return (
            ...
            e[0] === this.element[0]
              ...
              : !(!e || !e.length) && e.children(".jstree-children").children(".jstree-node")
          );
        },
        is_parent: function (e) {
          return (e = this.get_node(e)), e && (!1 === e.state.loaded || e.children.length > 0);
        },
        ...
        load_node: function (t, i) {
          ...
          if (t.state.loaded) {
            for (t.state.loaded = !1, a = 0, n = t.parents.length; n > a; a++)
            ...
            for (r = 0, s = t.children_d.length; s > r; r++)
              this._model.data[t.children_d[r]].state.selected && (o = !0), delete this._model.data[t.children_d[r]];
            o &&
              (this._data.core.selected = e.vakata.array_filter(this._data.core.selected, function (i) {
                return -1 === e.inArray(i, t.children_d);
              })),
              (t.children = []),
              (t.children_d = []),
            ...
            this._load_node(
              ...
              e.proxy(function (e) {
                ...
                var r = this.get_node(t, !0),
                  ...
                  n = this._model.data,
                  o = !1;
                for (s = 0, a = t.children.length; a > s; s++)
                  if (n[t.children[s]] && !n[t.children[s]].state.hidden) {
                    o = !0;
                    break;
                  }
                t.state.loaded &&
                  r &&
                  r.length &&
                  (r.removeClass("jstree-closed jstree-open jstree-leaf"),
                  o ? "#" !== t.id && r.addClass(t.state.opened ? "jstree-open" : "jstree-closed") : r.addClass("jstree-leaf")),
        ...
        _load_nodes: function (e, t, i, r) {
          ...
          for (s = 0, a = e.length; a > s; s++)
            d[e[s]] &&
              ((!d[e[s]].state.loaded && !d[e[s]].state.failed) || (!i && r)) &&
              (this.is_loading(e[s]) || this.load_node(e[s], o), (n = !1));
          if (n) {
            for (s = 0, a = e.length; a > s; s++) d[e[s]] && d[e[s]].state.loaded && c.push(e[s]);
        ...
        load_all: function (t, i) {
          ...
          var r,
            ...
            n = this._model.data,
            o = n[t.id].children_d;
          for (t.state && !t.state.loaded && a.push(t.id), r = 0, s = o.length; s > r; r++)
            ...
            ? e.isFunction(s)
              ? s.call(
                  ...
                  e.proxy(function (r) {
                    !1 === r
                      ? i.call(this, !1)
                      : this["string" == typeof r ? "_append_html_data" : "_append_json_data"](
                          t,
                          "string" == typeof r ? e(e.parseHTML(r)).filter(a) : r,
                          function (e) {
                            i.call(this, e);
                          },
                        );
              ...
              : "object" == typeof s
                ? s.url
                  ? ((s = e.extend(!0, {}, s)),
                    e.isFunction(s.url) && (s.url = s.url.call(this, t)),
                    e.isFunction(s.data) && (s.data = s.data.call(this, t)),
                    e
                      .ajax(s)
                      .done(
                        e.proxy(function (r, s, n) {
                          var o = n.getResponseHeader("Content-Type");
                          return (o && -1 !== o.indexOf("json")) || "object" == typeof r
                            ? this._append_json_data(t, r, function (e) {
                                i.call(this, e);
                              })
                            : (o && -1 !== o.indexOf("html")) || "string" == typeof r
                              ? this._append_html_data(t, e(e.parseHTML(r)).filter(a), function (e) {
                                  i.call(this, e);
                                })
                  ...
                  : ((r = e.isArray(s) ? e.extend(!0, [], s) : e.isPlainObject(s) ? e.extend(!0, {}, s) : s),
                    t.id === e.jstree.root
                      ? this._append_json_data(t, r, function (e) {
                          i.call(this, e);
                        })
                ...
                : "string" == typeof s
                  ? t.id === e.jstree.root
                    ? this._append_html_data(t, e(e.parseHTML(s)).filter(a), function (e) {
                        i.call(this, e);
                      })
                    : ((this._data.core.last_error = {
                        error: "nodata",
                  ...
                  : i.call(this, !1)
            : t.id === e.jstree.root
              ? this._append_html_data(t, this._data.core.original_container_html.clone(!0), function (e) {
                  i.call(this, e);
                })
              : i.call(this, !1);
        },
        _node_changed: function (t) {
          (t = this.get_node(t)), t && -1 === e.inArray(t.id, this._model.changed) && this._model.changed.push(t.id);
        },
        _append_html_data: function (t, i, r) {
          ...
          for (
            o.each(
              e.proxy(function (t, i) {
                (s = this._parse_model_from_html(e(i), d, _.parents.concat())),
                  s && (c.push(s), l.push(s), h[s].children_d.length && (l = l.concat(h[s].children_d)));
              }, this),
            ),
              _.children = c,
              _.children_d = l,
          ...
          this.trigger("model", { nodes: l, parent: d }),
            d !== e.jstree.root
              ...
              : (this.get_container_ul().children(".jstree-initial-node").remove(), this.redraw(!0)),
            this._data.core.selected.length !== u &&
              this.trigger("changed", {
                action: "model",
                selected: this._data.core.selected,
              }),
        ...
        _append_json_data: function (t, i, r, s) {
          if (null !== this.element) {
            (t = this.get_node(t)),
              (t.children = []),
              (t.children_d = []),
              i.d && ((i = i.d), "string" == typeof i && (i = JSON.parse(i))),
              e.isArray(i) || (i = [i]);
            var a = null,
              n = {
              ...
              d = function (e, t) {
                ...
                var i,
                  ...
                  v = function (e, i, r) {
                    ...
                    if (
                      (e && e.data && e.data.jstree && e.data.jstree.icon && (c.icon = e.data.jstree.icon),
                      (c.icon === t || null === c.icon || "" === c.icon) && (c.icon = !0),
                      e && e.data && ((c.data = e.data), e.data.jstree))
                    )
                    ...
                    for (
                      e && e.children && !0 === e.children && ((c.state.loaded = !1), (c.children = []), (c.children_d = [])),
                        f[c.id] = c,
                        s = 0,
                        a = c.children.length;
                      a > s;
                    ...
                    return delete e.data, delete e.children, (f[c.id].original = e), c.state.selected && h.push(c.id), c.id;
                  },
                  j = function (e, i, r) {
                    (r = r ? r.concat() : []), i && r.unshift(i);
                    var s,
                    ...
                    if (
                      (d.li_attr.id && !d.id && (d.id = d.li_attr.id.toString()),
                      d.id || (d.id = c),
                    ...
                    if (e && e.children && e.children.length) {
                      for (s = 0, a = e.children.length; a > s; s++)
                    ...
                    return (
                      e && e.children && !0 === e.children && ((d.state.loaded = !1), (d.children = []), (d.children_d = [])),
                      delete e.data,
                      delete e.children,
                      (d.original = e),
                      (f[d.id] = d),
                ...
                if (n.length && n[0].id !== t && n[0].parent !== t) {
                  for (r = 0, s = n.length; s > r; r++)
                    n[r].children || (n[r].children = []), n[r].state || (n[r].state = {}), (f[n[r].id.toString()] = n[r]);
                  for (r = 0, s = n.length; s > r; r++)
                    f[n[r].parent.toString()]
                      ? (f[n[r].parent.toString()].children.push(n[r].id.toString()), p.children_d.push(n[r].id.toString()))
                      : void 0 !== o &&
                  ...
                  for (r = 0, s = p.children.length; s > r; r++)
                    (i = v(f[p.children[r]], d, p.parents.concat())), l.push(i), f[i].children_d.length && (l = l.concat(f[i].children_d));
                  for (r = 0, s = p.parents.length; s > r; r++) f[p.parents[r]].children_d = f[p.parents[r]].children_d.concat(l);
                  a = {
                    cnt: g,
                    mod: f,
                    sel: m,
                  ...
                  for (r = 0, s = n.length; s > r; r++)
                    (i = j(n[r], d, p.parents.concat())), i && (c.push(i), l.push(i), f[i].children_d.length && (l = l.concat(f[i].children_d)));
                  for (p.children = c, p.children_d = l, r = 0, s = p.parents.length; s > r; r++)
                ...
                return "undefined" != typeof window && void 0 !== window.document ? a : void postMessage(a);
              },
              l = function (t, i) {
                if (null !== this.element) {
                  this._cnt = t.cnt;
                  ...
                  if (((this._model.data = t.mod), i)) {
                    ...
                    if (((a = this._model.data), l.length !== h.length || e.vakata.array_unique(l.concat(h)).length !== l.length)) {
                      for (s = 0, n = l.length; n > s; s++) -1 === e.inArray(l[s], d) && -1 === e.inArray(l[s], h) && (a[l[s]].state.selected = !1);
                      for (s = 0, n = h.length; n > s; s++) -1 === e.inArray(h[s], l) && (a[h[s]].state.selected = !0);
                    }
                  }
                  t.add.length && (this._data.core.selected = this._data.core.selected.concat(t.add)),
                    ...
                    t.par !== e.jstree.root ? (this._node_changed(t.par), this.redraw()) : this.redraw(!0),
                    t.add.length &&
                      this.trigger("changed", {
                        action: "model",
                        selected: this._data.core.selected,
              ...
              try {
                null === this._wrk &&
                  (this._wrk = window.URL.createObjectURL(
                    new window.Blob(["self.onmessage = " + d.toString()], {
                      type: "text/javascript",
                    }),
                  )),
                  !this._data.core.working || s
                    ? ((this._data.core.working = !0),
                      (a = new window.Worker(this._wrk)),
                      (a.onmessage = e.proxy(function (e) {
                      ...
                      n.par
                        ...
                        : this._data.core.worker_queue.length
                          ? this._append_json_data.apply(this, this._data.core.worker_queue.shift())
                          : (this._data.core.working = !1))
                    : this._data.core.worker_queue.push([t, i, r, !0]);
              } catch (e) {
                l.call(this, d(n), !1),
                  this._data.core.worker_queue.length
                    ? this._append_json_data.apply(this, this._data.core.worker_queue.shift())
        ...
        _parse_model_from_html: function (i, r, s) {
          ...
          if (
            ...
            e.each(d, function (t, i) {
              return (i = e.vakata.trim(i)), !i.length || ((h.li_attr[t] = i), void ("id" === t && (h.id = i.toString())));
            }),
            (d = i.children("a").first()),
            d.length &&
              ((d = e.vakata.attributes(d, !0)),
              e.each(d, function (t, i) {
                (i = e.vakata.trim(i)), i.length && (h.a_attr[t] = i);
              })),
            (d = i.children("a").first().length ? i.children("a").first().clone() : i.clone()),
          ...
          (d = i.children("a").children(".jstree-themeicon")),
            d.length && (h.icon = !d.hasClass("jstree-themeicon-hidden") && d.attr("rel")),
          ...
          return (
            ...
            d.length
              ...
              : i.hasClass("jstree-closed") && (h.state.loaded = !1),
        ...
        _parse_model_from_flat_json: function (e, i, r) {
          ...
          for (
            e && e.children && !0 === e.children && ((h.state.loaded = !1), (h.children = []), (h.children_d = [])),
              c[h.id] = h,
              s = 0,
              a = h.children.length;
            a > s;
            ...
            (n = this._parse_model_from_flat_json(c[h.children[s]], h.id, r)),
              (o = c[n]),
              h.children_d.push(n),
        ...
        _parse_model_from_json: function (e, i, r) {
          ...
          if (e && e.children && e.children.length) {
            for (s = 0, a = e.children.length; a > s; s++)
              (n = this._parse_model_from_json(e.children[s], d.id, r)),
                (o = l[n]),
                d.children.push(n),
                o.children_d.length && (d.children_d = d.children_d.concat(o.children_d));
        ...
        _redraw: function () {
          var t,
            i,
            r,
            s = this._model.force_full_redraw ? this._model.data[e.jstree.root].children.concat([]) : this._model.changed.concat([]),
            a = d.createElement("UL"),
            n = this._data.core.focused;
          for (i = 0, r = s.length; r > i; i++)
            (t = this.redraw_node(s[i], !0, this._model.force_full_redraw)), t && this._model.force_full_redraw && a.appendChild(t);
          this._model.force_full_redraw &&
            ((a.className = this.get_container_ul()[0].className), a.setAttribute("role", "group"), this.element.empty().append(a)),
            null !== n &&
              this.settings.core.restore_focus &&
              ((t = this.get_node(n, !0)),
              t && t.length && t.children(".jstree-anchor")[0] !== d.activeElement
        ...
        draw_children: function (t) {
          ...
          if ((t.children(".jstree-children").remove(), (t = t[0]), i.children.length && i.state.loaded)) {
            for (
              a = n.createElement("UL"), a.setAttribute("role", "group"), a.className = "jstree-children", r = 0, s = i.children.length;
              s > r;
              r++
            )
        ...
        redraw_node: function (t, i, r, s) {
          ...
          if (
              ...
              ? this.element[0].querySelector(
                  "#" +
                    (-1 !== "0123456789".indexOf(a.id[0])
                      ? "\\3" + a.id[0] + " " + a.id.substr(1).replace(e.jstree.idregex, "\\$&")
                      : a.id.replace(e.jstree.idregex, "\\$&")),
                )
              : d.getElementById(a.id)))
          )
            (t = e(t)),
              r || ((n = t.parent().parent()[0]), n === this.element[0] && (n = null), (o = t.index())),
            ...
            if (
              ((n = a.parent !== e.jstree.root ? e("#" + a.parent.replace(e.jstree.idregex, "\\$&"), this.element)[0] : null),
              !(null === n || (n && f[a.parent].state.opened)))
            )
              return !1;
            o = e.inArray(a.id, null === n ? f[e.jstree.root].children : f[a.parent].children);
          }
          for (l in ((t = this._data.core.node.cloneNode(!0)), (u = "jstree-node "), a.li_attr))
          ...
          for (
            a.a_attr.id || (a.a_attr.id = a.id + "_anchor"),
              ...
              this.settings.core.compute_elements_positions &&
                (t.childNodes[1].setAttribute("aria-setsize", f[a.parent].children.length),
          ...
          if (null !== a.parent && f[a.parent] && !a.state.hidden && ((l = e.inArray(a.id, f[a.parent].children)), (k = a.id), -1 !== l))
            for (
              l++, h = f[a.parent].children.length;
              h > l && (f[f[a.parent].children[l]].state.hidden || (k = f[a.parent].children[l]), k === a.id);
              l++
            );
          ...
          a.state.loaded && !y
            ? (u += " jstree-leaf")
            : ((u += a.state.opened && a.state.loaded ? " jstree-open" : " jstree-closed"),
              t.childNodes[1].setAttribute("aria-expanded", a.state.opened && a.state.loaded)),
          k === a.id && (u += " jstree-last"),
          (t.id = a.id),
          (t.className = u),
          ...
          if (
            (u.length && (t.childNodes[1].className = "jstree-anchor " + u),
            ((a.icon && !0 !== a.icon) || !1 === a.icon) &&
              (!1 === a.icon
                ? (t.childNodes[1].childNodes[0].className += " jstree-themeicon-hidden")
                : -1 === a.icon.indexOf("/") && -1 === a.icon.indexOf(".")
                  ? (t.childNodes[1].childNodes[0].className += " " + a.icon + " jstree-themeicon-custom")
                  : ((t.childNodes[1].childNodes[0].style.backgroundImage = 'url("' + a.icon + '")'),
            ...
            for (
              _ = g.createElement("UL"), _.setAttribute("role", "group"), _.className = "jstree-children", l = 0, h = a.children.length;
              h > l;
              l++
            )
          ...
          if ((c && t.appendChild(c), !r)) {
            for (n || (n = this.element[0]), l = 0, h = n.childNodes.length; h > l; l++)
              if (n.childNodes[l] && n.childNodes[l].className && -1 !== n.childNodes[l].className.indexOf("jstree-children")) {
                m = n.childNodes[l];
                break;
              }
            m || ((m = g.createElement("UL")), m.setAttribute("role", "group"), (m.className = "jstree-children"), n.appendChild(m)),
              (n = m),
              o < n.childNodes.length ? n.insertBefore(t, n.childNodes[o]) : n.appendChild(t),
              p &&
        ...
        open_node: function (i, r, s) {
          var a, n, o, d;
          if (e.isArray(i)) {
            for (i = i.slice(), a = 0, n = i.length; n > a; a++) this.open_node(i[a], r, s);
            return !0;
          }
          return (
            (i = this.get_node(i)),
            !(!i || i.id === e.jstree.root) &&
              ...
              this.is_closed(i)
                ? this.is_loaded(i)
                  ? ((o = this.get_node(i, !0)),
                    (d = this),
                    o.length &&
                      (s && o.children(".jstree-children").length && o.children(".jstree-children").stop(!0, !0),
                        ...
                        ? (this.trigger("before_open", {
                          ...
                          o
                            ...
                            .slideDown(s, function () {
                              (this.style.display = ""), d.element && d.trigger("after_open", { node: i });
                            }))
                        : (this.trigger("before_open", {
                            node: i,
                          }),
        ...
        close_node: function (i, r) {
          var s, a, n, o;
          if (e.isArray(i)) {
            for (i = i.slice(), s = 0, a = i.length; a > s; s++) this.close_node(i[s], r);
            return !0;
          }
          return (
            (i = this.get_node(i)),
        ...
        open_all: function (t, i, r) {
          ...
          var s,
            a,
            n,
            o = t.id === e.jstree.root ? this.get_container_ul() : this.get_node(t, !0);
          if (!o.length) {
            for (s = 0, a = t.children_d.length; a > s; s++)
          ...
          (r = r || o),
            (n = this),
            (o = this.is_closed(t) ? o.find(".jstree-closed").addBack() : o.find(".jstree-closed")),
            o.each(function () {
              n.open_node(
                this,
                function (e, t) {
        ...
        close_all: function (t, i) {
          ...
          var r,
            s,
            a = t.id === e.jstree.root ? this.get_container_ul() : this.get_node(t, !0),
            n = this;
          for (
            a.length &&
              ((a = this.is_open(t) ? a.find(".jstree-open").addBack() : a.find(".jstree-open")),
        ...
        disable_node: function (t) {
          ...
          return (
            ...
            !(!t || t.id === e.jstree.root) &&
              ...
              void this.trigger("disable_node", { node: t }))
          );
        },
        is_hidden: function (e) {
          return (e = this.get_node(e)), !0 === e.state.hidden;
        },
        hide_node: function (t, i) {
          ...
          return (
            ...
            !(!t || t.id === e.jstree.root) &&
              void (
                t.state.hidden || ((t.state.hidden = !0), this._node_changed(t.parent), i || this.redraw(), this.trigger("hide_node", { node: t }))
              )
          );
        },
        show_node: function (t, i) {
          ...
          return (
            ...
            !(!t || t.id === e.jstree.root) &&
              void (
                t.state.hidden && ((t.state.hidden = !1), this._node_changed(t.parent), i || this.redraw(), this.trigger("show_node", { node: t }))
              )
          );
        },
        hide_all: function (t) {
        ...
        activate_node: function (e, i) {
          ...
          if (
            ...
            (this._data.core.last_clicked =
              this._data.core.last_clicked && this._data.core.last_clicked.id !== t ? this.get_node(this._data.core.last_clicked.id) : null),
            ...
            this.settings.core.multiple &&
              ...
              (!i.shiftKey || (this._data.core.last_clicked && this.get_parent(e) && this.get_parent(e) === this._data.core.last_clicked.parent)))
          )
            if (i.shiftKey) {
              var r,
                s,
                ...
                d = !1;
              for (r = 0, s = o.length; s > r; r += 1)
                o[r] === a && (d = !d),
                  o[r] === n && (d = !d),
                  this.is_disabled(o[r]) || (!d && o[r] !== a && o[r] !== n)
                    ? this.deselect_node(o[r], !0, i)
                    : this.is_hidden(o[r]) || this.select_node(o[r], !0, !1, i);
              this.trigger("changed", {
                action: "select_node",
            ...
            !this.settings.core.multiple && (i.metaKey || i.ctrlKey || i.shiftKey) && this.is_selected(e)
              ? this.deselect_node(e, !1, i)
              : (this.deselect_all(!0), this.select_node(e, !1, !1, i), (this._data.core.last_clicked = this.get_node(e)));
        ...
        select_node: function (t, i, r, s) {
          var a, n, o;
          if (e.isArray(t)) {
            for (t = t.slice(), n = 0, o = t.length; o > n; n++) this.select_node(t[n], i, r, s);
            return !0;
          }
          return (
            (t = this.get_node(t)),
        ...
        deselect_node: function (t, i, r) {
          var s, a, n;
          if (e.isArray(t)) {
            for (t = t.slice(), s = 0, a = t.length; a > s; s++) this.deselect_node(t[s], i, r);
            return !0;
          }
          return (
            (t = this.get_node(t)),
        ...
        select_all: function (t) {
          ...
          for (this._data.core.selected = this._model.data[e.jstree.root].children_d.concat(), i = 0, r = this._data.core.selected.length; r > i; i++)
        ...
        is_selected: function (t) {
          return (t = this.get_node(t)), !(!t || t.id === e.jstree.root) && t.state.selected;
        },
        ...
        get_top_selected: function (t) {
          var i,
            ...
            o = {};
          for (i = 0, r = n.length; r > i; i++) o[n[i].id] = n[i];
          for (i = 0, r = n.length; r > i; i++)
            for (s = 0, a = n[i].children_d.length; a > s; s++) o[n[i].children_d[s]] && delete o[n[i].children_d[s]];
        ...
        get_bottom_selected: function (t) {
          var i,
            ...
            a = [];
          for (i = 0, r = s.length; r > i; i++) s[i].children.length || a.push(s[i].id);
          return t
            ? e.map(
                a,
                e.proxy(function (e) {
        ...
        get_state: function () {
          ...
          for (t in this._model.data)
            this._model.data.hasOwnProperty(t) &&
              t !== e.jstree.root &&
              (this._model.data[t].state.loaded && this.settings.core.loaded_state && i.core.loaded.push(t),
          ...
          if (i) {
            if (
              (i.core &&
                ...
                (i.core.initial_selection = this._data.core.selected.concat([]).sort().join(",")),
              i.core)
            ) {
              var s, a;
              if (i.core.loaded)
                return (
                  this.settings.core.loaded_state && e.isArray(i.core.loaded) && i.core.loaded.length
                    ? this._load_nodes(i.core.loaded, function (e) {
              ...
              if (i.core.open)
                return (
                  e.isArray(i.core.open) && i.core.open.length
                    ? this._load_nodes(i.core.open, function (e) {
                        this.open_node(e, !1, 0), delete i.core.open, this.set_state(i, r);
                      })
                    : (delete i.core.open, this.set_state(i, r)),
                  !1
                );
              if (i.core.scroll)
                return (
                  i.core.scroll && i.core.scroll.left !== t && this.element.scrollLeft(i.core.scroll.left),
              ...
              if (i.core.selected)
                return (
                  (s = this),
                  (i.core.initial_selection === t || i.core.initial_selection === this._data.core.selected.concat([]).sort().join(",")) &&
                    (this.deselect_all(),
              ...
              for (a in i) i.hasOwnProperty(a) && "core" !== a && -1 === e.inArray(a, this.settings.plugins) && delete i[a];
        ...
        set_id: function (t, i) {
          ...
          var r,
            ...
            a = this._model.data,
            n = t.id;
          for (i = i.toString(), a[t.parent].children[e.inArray(t.id, a[t.parent].children)] = i, r = 0, s = t.parents.length; s > r; r++)
            a[t.parents[r]].children_d[e.inArray(t.id, a[t.parents[r]].children_d)] = i;
          for (r = 0, s = t.children.length; s > r; r++) a[t.children[r]].parent = i;
          for (r = 0, s = t.children_d.length; s > r; r++) a[t.children_d[r]].parents[e.inArray(t.id, a[t.children_d[r]].parents)] = i;
          return (
            (r = e.inArray(t.id, this._data.core.selected)),
            -1 !== r && (this._data.core.selected[r] = i),
            (r = this.get_node(t.id, !0)),
            r && (r.attr("id", i), this.element.attr("aria-activedescendant") === t.id && this.element.attr("aria-activedescendant", i)),
            delete a[t.id],
            (t.id = i),
            (t.li_attr.id = i),
            (a[i] = t),
        ...
        get_text: function (t) {
          return (t = this.get_node(t)), !(!t || t.id === e.jstree.root) && t.text;
        },
        set_text: function (t, i) {
          ...
          return (
            (t = this.get_node(t)),
            !(!t || t.id === e.jstree.root) &&
              ((t.text = i), this.get_node(t, !0).length && this.redraw_node(t.id), this.trigger("set_text", { obj: t, text: i }), !0)
          );
        },
        get_json: function (t, i, r) {
          ...
          if ((i && i.flat ? (n.parent = t.parent) : (n.children = []), i && i.no_state)) delete n.state;
          ...
          if (
            ...
            i && i.no_id && (delete n.id, n.li_attr && n.li_attr.id && delete n.li_attr.id, n.a_attr && n.a_attr.id && delete n.a_attr.id),
        ...
        create_node: function (i, r, s, a, n) {
          ...
          if (((s = s === t ? "last" : s), !s.toString().match(/^(before|after)$/) && !n && !this.is_loaded(i)))
          ...
          switch (
            ...
            (r = "string" == typeof r ? { text: r } : e.extend(!0, {}, r)),
            r.text === t && (r.text = this.get_string("New node")),
            i.id === e.jstree.root && ("before" === s && (s = "first"), "after" === s && (s = "last")),
            s)
          ) {
            case "before":
          ...
          if ((!0 === r.id && delete r.id, (r = this._parse_model_from_json(r, i.id, i.parents.concat())), !r)) return !1;
          for (
            o = this.get_node(r),
              d = [],
              d.push(r),
        ...
        delete_node: function (t) {
          ...
          if (((t = this.get_node(t)), !t || t.id === e.jstree.root)) return !1;
          if (((s = this.get_node(t.parent)), (a = e.inArray(t.id, s.children)), (h = !1), !this.check("delete_node", t, s, a)))
            return this.settings.core.error.call(this, this._data.core.last_error), !1;
          for (
            -1 !== a && (s.children = e.vakata.array_remove(s.children, a)), n = t.children_d.concat([]), n.push(t.id), o = 0, d = t.parents.length;
            d > o;
            o++
          )
          ...
          for (
            h &&
              (this._data.core.selected = e.vakata.array_filter(this._data.core.selected, function (t) {
                return -1 === e.inArray(t, n);
              })),
            ...
            -1 !== e.inArray(this._data.core.focused, n) &&
              ...
              s.id === e.jstree.root
                ? this._model.data[e.jstree.root].children[0] &&
                  this.get_node(this._model.data[e.jstree.root].children[0], !0).children(".jstree-anchor").focus()
                : this.get_node(s, !0).children(".jstree-anchor").focus(),
        ...
        check: function (t, i, r, s, a) {
          ...
          return (
            n && n.data && (n = n.data),
            n && n.functions && (!1 === n.functions[t] || !0 === n.functions[t])
              ? (!1 === n.functions[t] &&
                  (this._data.core.last_error = {
                    error: "check",
                    plugin: "core",
                ...
                n.functions[t])
              : !(!1 === o || (e.isFunction(o) && !1 === o.call(this, t, i, r, s, a)) || (o && !1 === o[t])) ||
                ((this._data.core.last_error = {
                  error: "check",
                  plugin: "core",
                  id: "core_03",
        ...
        move_node: function (i, r, s, a, n, o, d) {
          ...
          if (e.isArray(i)) {
            if (1 !== i.length) {
              for (c = 0, l = i.length; l > c; c++) (m = this.move_node(i[c], r, s, a, n, !1, d)) && ((r = m), (s = "after"));
          ...
          if (
            ...
            (g = d || (this._model.data[i.id] ? this : e.jstree.reference(i.id))),
            (f = !g || !g._id || this._id !== g._id),
            ...
            return !!(m = this.copy_node(i, r, s, a, n, !1, d)) && (g && g.delete_node(i), m);
          ...
          if (
            (s > u.children.length && (s = u.children.length),
          ...
          if (i.parent === u.id) {
            for (
              p = u.children.concat(),
                m = e.inArray(i.id, p),
                -1 !== m && ((p = e.vakata.array_remove(p, m)), s > m && s--),
                m = [],
                v = 0,
                j = p.length;
              j > v;
            ...
            for (g._model.data[h].children = e.vakata.array_remove_item(g._model.data[h].children, i.id), v = 0, j = u.parents.length; j > v; v++)
            ...
            for (
              ...
              (this._model.data[i.children_d[v]].parents = this._model.data[i.children_d[v]].parents.slice(0, -1 * x)),
            ...
            (h === e.jstree.root || u.id === e.jstree.root) && (this._model.force_full_redraw = !0),
              this._model.force_full_redraw || (this._node_changed(h), this._node_changed(u.id)),
              o || this.redraw();
          }
          return (
            a && a.call(this, i, u, s),
        ...
        copy_node: function (i, r, s, a, n, o, d) {
          ...
          if (e.isArray(i)) {
            if (1 !== i.length) {
              for (c = 0, l = i.length; l > c; c++) (_ = this.copy_node(i[c], r, s, a, n, !0, d)) && ((r = _), (s = "after"));
              return this.redraw(), !0;
            }
            i = i[0];
          }
          ...
          switch (
            ...
            (v = d || (this._model.data[i.id] ? this : e.jstree.reference(i.id))),
            !v || !v._id || this._id !== v._id,
            v && v._id && (i = v._model.data[i.id]),
            r.id === e.jstree.root && ("before" === s && (s = "first"), "after" === s && (s = "last")),
            s)
          ) {
            case "before":
          ...
          if (
            ...
            return !1;
          if ((!0 === f.id && delete f.id, (f = this._parse_model_from_json(f, m.id, m.parents.concat())), !f)) return !1;
          for (
            _ = this.get_node(f),
        ...
        cut: function (t) {
          ...
          var i,
            ...
            o,
            d = [];
          for (n = 0, o = t.length; o > n; n++) (i = this.get_node(t[n])), i && i.id && i.id !== e.jstree.root && d.push(i);
          return !!d.length && ((r = d), (a = this), (s = "move_node"), void this.trigger("cut", { node: t }));
        },
        copy: function (t) {
          if ((t || (t = this._data.core.selected.concat()), e.isArray(t) || (t = [t]), !t.length)) return !1;
          var i,
            ...
            d = [];
          for (n = 0, o = t.length; o > n; n++) (i = this.get_node(t[n])), i && i.id && i.id !== e.jstree.root && d.push(i);
          return !!d.length && ((r = d), (a = this), (s = "copy_node"), void this.trigger("copy", { node: t }));
        },
        get_buffer: function () {
        ...
        paste: function (e, t) {
          return (
            (e = this.get_node(e)),
            !!(e && s && s.match(/^(copy_node|move_node)$/) && r) &&
          ...
          return (
            ...
            (this.check("edit", t, this.get_parent(t))
              ? ((u = t),
                ...
                (n = t.children(".jstree-anchor").focus()),
                (o = e("<span></span>")),
                (c = i),
                (l = e("<div></div>", {
                  css: {
                ...
                (h = e("<input />", {
                  ...
                  blur: e.proxy(function (i) {
                    ...
                    var s,
                      a = o.children(".jstree-rename-input"),
                      d = a.val(),
                      _ = this.settings.core.force_text;
                    "" === d && (d = c),
                      l.remove(),
                      o.replaceWith(n),
                      o.remove(),
                      (c = _ ? c : e("<div></div>").append(e.parseHTML(c)).html()),
                      (t = this.get_node(t)),
                      this.set_text(t, c),
                      (s = !!this.rename_node(t, _ ? e("<div></div>").text(d).text() : e("<div></div>").append(e.parseHTML(d)).html())),
                      s || this.set_text(t, c),
                      (this._data.core.focused = u.id),
                      setTimeout(
                        e.proxy(function () {
                      ...
                      r && r.call(this, u, s, g, d),
                      (h = null);
                  }, this),
                  keydown: function (e) {
                    var t = e.which;
                    27 === t && ((g = !0), (this.value = c)),
                ...
                h
                  .css(_)
                  .width(Math.min(l.text("pW" + h[0].value).width(), a))[0]
                  .select(),
        ...
        set_theme: function (t, i) {
          ...
          i && -1 === e.inArray(i, n) && (e("head").append('<link rel="stylesheet" href="' + i + '" type="text/css" />'), n.push(i)),
        ...
        set_icon: function (i, r) {
          var s, a, n, o;
          if (e.isArray(i)) {
            for (i = i.slice(), s = 0, a = i.length; a > s; s++) this.set_icon(i[s], r);
            return !0;
          }
          return (
            (i = this.get_node(i)),
                  ...
                  : -1 === r.indexOf("/") && -1 === r.indexOf(".")
                    ...
                    : (n.removeClass(o).css("background", ""),
                      n
                        ...
                        .css("background", "url('" + r + "') center center no-repeat")
                        .attr("rel", r),
                      !1 === o && this.show_icon(i)),
              !0)
          );
        ...
        get_icon: function (t) {
          return (t = this.get_node(t)), !(!t || t.id === e.jstree.root) && t.icon;
        },
        hide_icon: function (t) {
          ...
          return (
            (t = this.get_node(t)),
            !(!t || t === e.jstree.root) &&
              ((t.icon = !1), this.get_node(t, !0).children(".jstree-anchor").children(".jstree-themeicon").addClass("jstree-themeicon-hidden"), !0)
          );
        },
        ...
        return (
          t &&
            ...
            e.each(t.attributes, function (t, s) {
              -1 === e.inArray(s.name.toLowerCase(), ["style", "contenteditable", "hasfocus", "tabindex"]) &&
                null !== s.value &&
      ...
      (e.vakata.array_unique = function (e) {
        var i,
          ...
          s = [],
          a = {};
        for (i = 0, r = e.length; r > i; i++) a[e[i]] === t && (s.push(e[i]), (a[e[i]] = !0));
        return s;
      }),
      ...
      (e.jstree.plugins.changed = function (e, t) {
        ...
        (this.trigger = function (e, r) {
          ...
          if ((r || (r = {}), "changed" === e.replace(".jstree", ""))) {
            ...
            var n = {};
            for (s = 0, a = i.length; a > s; s++) n[i[s]] = 1;
            for (s = 0, a = r.selected.length; a > s; s++) n[r.selected[s]] ? (n[r.selected[s]] = 2) : r.changed.selected.push(r.selected[s]);
            for (s = 0, a = i.length; a > s; s++) 1 === n[i[s]] && r.changed.deselected.push(i[s]);
            i = r.selected.slice();
          }
    ...
    (u.className = "jstree-icon jstree-checkbox"),
        ...
        (this.bind = function () {
              ...
              this.element
                  ...
                  e.proxy(function (t, i) {
                    ...
                    if (-1 !== u.indexOf("down"))
                      if (l.state[g ? "selected" : "checked"]) {
                        for (s = 0, a = h.length; a > s; s++) c[h[s]].state[g ? "selected" : "checked"] = !0;
                        this._data[g ? "core" : "checkbox"].selected = this._data[g ? "core" : "checkbox"].selected.concat(h);
                      } else
                        for (s = 0, a = h.length; a > s; s++)
                          if (c[h[s]].state[g ? "selected" : "checked"]) {
                            for (n = 0, o = c[h[s]].children_d.length; o > n; n++) c[c[h[s]].children_d[n]].state[g ? "selected" : "checked"] = !0;
                            this._data[g ? "core" : "checkbox"].selected = this._data[g ? "core" : "checkbox"].selected.concat(c[h[s]].children_d);
                          }
                    if (-1 !== u.indexOf("up")) {
                      for (s = 0, a = l.children_d.length; a > s; s++) c[l.children_d[s]].children.length || _.push(c[l.children_d[s]].parent);
                      for (_ = e.vakata.array_unique(_), n = 0, o = _.length; o > n; n++)
                        for (l = c[_[n]]; l && l.id !== e.jstree.root; ) {
                          for (r = 0, s = 0, a = l.children.length; a > s; s++) r += c[l.children[s]].state[g ? "selected" : "checked"];
                          if (r !== a) break;
                          (l.state[g ? "selected" : "checked"] = !0),
                            ...
                            d &&
                              ...
                              d
                                ...
                                .children(".jstree-anchor")
                                .addClass(g ? "jstree-clicked" : "jstree-checked"),
                ...
                .on(
                  ...
                  e.proxy(function (t, i) {
                    ...
                    for (r = 0, s = u.length; s > r; r++) _[u[r]] = !0;
                    if (-1 !== l.indexOf("down")) {
                      var g = this._cascade_new_checked_state(o.id, !0),
                        f = o.children_d.concat(o.id);
                      for (r = 0, s = f.length; s > r; r++) g.indexOf(f[r]) > -1 ? (_[f[r]] = !0) : delete _[f[r]];
                    }
                    if (-1 !== l.indexOf("up"))
                      for (; c && c.id !== e.jstree.root; ) {
                        for (a = 0, r = 0, s = c.children.length; s > r; r++) a += d[c.children[r]].state[h ? "selected" : "checked"];
                        if (a !== s) break;
                        (c.state[h ? "selected" : "checked"] = !0),
                          ...
                          n &&
                            ...
                            n
                              .attr("aria-selected", !0)
                              .children(".jstree-anchor")
                              .addClass(h ? "jstree-clicked" : "jstree-checked"),
                ...
                .on(
                  ...
                  e.proxy(function (t, i) {
                    var r,
                      ...
                      o = this._model.data;
                    for (r = 0, s = n.children_d.length; s > r; r++)
                      (a = o[n.children_d[r]]),
                ...
                .on(
                  ...
                  e.proxy(function (t, i) {
                    var r,
                      ...
                      a,
                      n = i.node,
                      o = (this.get_node(n, !0), this.settings.checkbox.cascade),
                    ...
                    if (-1 !== o.indexOf("up") && -1 === c.indexOf(n.id)) {
                      for (r = 0, s = n.parents.length; s > r; r++)
                        (a = this._model.data[n.parents[r]]),
                          (a.state[d ? "selected" : "checked"] = !1),
                          a && a.original && a.original.state && a.original.state.undetermined && (a.original.state.undetermined = !1),
                          (a = this.get_node(n.parents[r], !0)),
                          a &&
                            a.length &&
                            a
            ...
            -1 !== this.settings.checkbox.cascade.indexOf("up") &&
              this.element
                .on(
                  ...
                  e.proxy(function (t, i) {
                    for (
                      var r, s, a, n, o = this.get_node(i.parent), d = this._model.data, c = this.settings.checkbox.tie_selection;
                      o && o.id !== e.jstree.root && !o.state[c ? "selected" : "checked"];

                    ) {
                      for (a = 0, r = 0, s = o.children.length; s > r; r++) a += d[o.children[r]].state[c ? "selected" : "checked"];
                      if (!(s > 0 && a === s)) break;
                  ...
                  e.proxy(function (t, i) {
                    ...
                    if (!d)
                      for (r = this.get_node(c); r && r.id !== e.jstree.root && !r.state[_ ? "selected" : "checked"]; ) {
                        for (s = 0, a = 0, n = r.children.length; n > a; a++) s += h[r.children[a]].state[_ ? "selected" : "checked"];
                        if (!(n > 0 && s === n)) break;
                        (r.state[_ ? "selected" : "checked"] = !0),
                          ...
                          o &&
                            ...
                            o
                              .attr("aria-selected", !0)
                              .children(".jstree-anchor")
                              .addClass(_ ? "jstree-clicked" : "jstree-checked"),
                          (r = this.get_node(r.parent));
                      }
                    for (r = l; r && r.id !== e.jstree.root; ) {
                      for (s = 0, a = 0, n = r.children.length; n > a; a++) s += h[r.children[a]].state[_ ? "selected" : "checked"];
                      if (s === n)
                        r.state[_ ? "selected" : "checked"] ||
                          ((r.state[_ ? "selected" : "checked"] = !0),
                          this._data[_ ? "core" : "checkbox"].selected.push(r.id),
                          (o = this.get_node(r, !0)),
                          o &&
                        ...
                        (r.state[_ ? "selected" : "checked"] = !1),
                          (this._data[_ ? "core" : "checkbox"].selected = e.vakata.array_remove_item(
                          ...
                          o &&
                            ...
                            o
                              .attr("aria-selected", !1)
                              .children(".jstree-anchor")
                              .removeClass(_ ? "jstree-clicked" : "jstree-checked");
                      }
                      r = this.get_node(r.parent);
                    }
                  }, this),
          ...
          (this.get_undetermined = function (i) {
            ...
            for (r = 0, s = l.length; s > r; r++)
              if (d[l[r]] && d[l[r]].parents)
                for (a = 0, n = d[l[r]].parents.length; n > a && o[d[l[r]].parents[a]] === t; a++)
                  d[l[r]].parents[a] !== e.jstree.root && ((o[d[l[r]].parents[a]] = !0), h.push(d[l[r]].parents[a]));
            for (
              this.element
                .find(".jstree-closed")
                ...
                .each(function () {
                  ...
                  if (c)
                    if (c.state.loaded) {
                      for (r = 0, s = c.children_d.length; s > r; r++)
                        if (
                          ((i = d[c.children_d[r]]),
                          !i.state.loaded && i.original && i.original.state && i.original.state.undetermined && !0 === i.original.state.undetermined)
                        )
                          for (o[i.id] === t && i.id !== e.jstree.root && ((o[i.id] = !0), h.push(i.id)), a = 0, n = i.parents.length; n > a; a++)
                            o[i.parents[a]] === t && i.parents[a] !== e.jstree.root && ((o[i.parents[a]] = !0), h.push(i.parents[a]));
                    } else if (c.original && c.original.state && c.original.state.undetermined && !0 === c.original.state.undetermined)
                      for (o[c.id] === t && c.id !== e.jstree.root && ((o[c.id] = !0), h.push(c.id)), a = 0, n = c.parents.length; n > a; a++)
                        o[c.parents[a]] === t && c.parents[a] !== e.jstree.root && ((o[c.parents[a]] = !0), h.push(c.parents[a]));
                }),
                r = 0,
                s = h.length;
              s > r;
          ...
          (this._undetermined = function () {
            if (null !== this.element) {
              ...
              for (this.element.find(".jstree-undetermined").removeClass("jstree-undetermined"), e = 0, t = r.length; t > e; e++)
                (i = this.get_node(r[e], !0)),
                  i && i.length && i.children(".jstree-anchor").children(".jstree-checkbox").addClass("jstree-undetermined");
            }
          }),
          (this.redraw_node = function (t, i, s, a) {
            if ((t = r.redraw_node.apply(this, arguments))) {
              var n,
                ...
                d = null,
                c = null;
              for (n = 0, o = t.childNodes.length; o > n; n++)
                if (t.childNodes[n] && t.childNodes[n].className && -1 !== t.childNodes[n].className.indexOf("jstree-anchor")) {
                  d = t.childNodes[n];
                  break;
                }
              d &&
                (!this.settings.checkbox.tie_selection && this._model.data[t.id].state.checked && (d.className += " jstree-checked"),
                (c = u.cloneNode(!1)),
                this._model.data[t.id].state.checkbox_disabled && (c.className += " jstree-checkbox-disabled"),
                d.insertBefore(c, d.childNodes[0]));
            }
            return (
              s ||
                -1 === this.settings.checkbox.cascade.indexOf("undetermined") ||
          ...
          (this.is_undetermined = function (t) {
            ...
            for (i = 0, r = t.children_d.length; r > i; i++)
          ...
          (this.activate_node = function (t, i) {
            return (
              ...
              (this.settings.checkbox.tie_selection &&
                (this.settings.checkbox.whole_node || e(i.target).hasClass("jstree-checkbox")) &&
                (i.ctrlKey = !0),
              this.settings.checkbox.tie_selection || (!this.settings.checkbox.whole_node && !e(i.target).hasClass("jstree-checkbox"))
                ? r.activate_node.call(this, t, i)
                : !this.is_disabled(t) &&
                  (this.is_checked(t) ? this.uncheck_node(t, i) : this.check_node(t, i),
          ...
          (this._cascade_new_checked_state = function (e, t) {
            var i,
              ...
              o = this._model.data[e],
              d = [],
              c = [];
            if ((!this.settings.checkbox.cascade_to_disabled && o.state.disabled) || (!this.settings.checkbox.cascade_to_hidden && o.state.hidden))
              (s = this.get_checked_descendants(e)), o.state[n ? "selected" : "checked"] && s.push(o.id), (d = d.concat(s));
            else {
              if (o.children)
                for (i = 0, r = o.children.length; r > i; i++) {
                  var l = o.children[i];
                  (s = a._cascade_new_checked_state(l, t)), (d = d.concat(s)), s.indexOf(l) > -1 && c.push(l);
                }
              var h = a.get_node(o, !0),
                _ = c.length > 0 && c.length < o.children.length;
              o.original && o.original.state && o.original.state.undetermined && (o.original.state.undetermined = _),
                _
                  ? ((o.state[n ? "selected" : "checked"] = !1),
                    h
                      .attr("aria-selected", !1)
                      .children(".jstree-anchor")
                      .removeClass(n ? "jstree-clicked" : "jstree-checked"))
                  : t && c.length === o.children.length
                    ? ((o.state[n ? "selected" : "checked"] = t),
                      d.push(o.id),
                      h
                        .attr("aria-selected", !0)
                        .children(".jstree-anchor")
                        .addClass(n ? "jstree-clicked" : "jstree-checked"))
                    : ((o.state[n ? "selected" : "checked"] = !1),
                      h
                        .attr("aria-selected", !1)
                        .children(".jstree-anchor")
          ...
          (this.check_node = function (t, i) {
            ...
            var r, s, a;
            if (e.isArray(t)) {
              for (t = t.slice(), s = 0, a = t.length; a > s; s++) this.check_node(t[s], i);
              return !0;
            }
            return (
              (t = this.get_node(t)),
          ...
          (this.check_all = function () {
            ...
            for (
              this._data.checkbox.selected = this._model.data[e.jstree.root].children_d.concat(), t = 0, i = this._data.checkbox.selected.length;
              i > t;
              t++
            )
          ...
          (this.uncheck_all = function () {
            ...
            for (e = 0, t = this._data.checkbox.selected.length; t > e; e++)
          ...
          (this.is_checked = function (t) {
            return this.settings.checkbox.tie_selection
              ? this.is_selected(t)
              : ((t = this.get_node(t)), !(!t || t.id === e.jstree.root) && t.state.checked);
          }),
          ...
          (this.load_node = function (t, i) {
            var s, a, n;
            if (!e.isArray(t) && !this.settings.checkbox.tie_selection && ((n = this.get_node(t)), n && n.state.loaded))
              for (s = 0, a = n.children_d.length; a > s; s++)
                this._model.data[n.children_d[s]].state.checked &&
                  (!0, (this._data.checkbox.selected = e.vakata.array_remove_item(this._data.checkbox.selected, n.children_d[s])));
      ...
      (e.jstree.plugins.conditionalselect = function (e, t) {
        this.activate_node = function (e, i) {
          return this.settings.conditionalselect.call(this, this.get_node(e), i) ? t.activate_node.call(this, e, i) : void 0;
        };
      }),
      ...
      (e.jstree.plugins.contextmenu = function (i, r) {
        (this.bind = function () {
          ...
          this.element
            ...
            .on("touchstart.jstree", ".jstree-anchor", function (r) {
              r.originalEvent &&
                r.originalEvent.changedTouches &&
                r.originalEvent.changedTouches[0] &&
                ((t = r.originalEvent.changedTouches[0].clientX),
            ...
            .on("touchmove.vakata.jstree", function (r) {
              a &&
                ...
                r.originalEvent.changedTouches &&
                r.originalEvent.changedTouches[0] &&
                (Math.abs(t - r.originalEvent.changedTouches[0].clientX) > 10 || Math.abs(i - r.originalEvent.changedTouches[0].clientY) > 10) &&
          ...
          (this.show_contextmenu = function (i, r, s, a) {
            ...
            var n = this.settings.contextmenu,
              o = this.get_node(i, !0),
              d = o.children(".jstree-anchor"),
              c = !1,
              l = !1;
            (n.show_at_node || r === t || s === t) && ((c = d.offset()), (r = c.left), (s = c.top + this._data.core.li_height)),
          ...
          (this._show_contextmenu = function (t, i, r, s) {
            ...
            e(d).one(
              ...
              e.vakata.context.show(n, { x: i, y: r }, s),
        ...
        (e.vakata.context = {
          ...
          _parse: function (t, r) {
            ...
            return (
                ...
                return (
                  ...
                  !n &&
                    ...
                    (a +=
                      ...
                      (e.vakata.context.settings.icons ? "" : 'style="margin-left:0px;"') +
                      ">&#160;</a></li>"),
                  (n = !1),
                  (a +=
                    "<li class='" +
                    ...
                    (e.isFunction(r._disabled) &&
                      ...
                      : "") +
                    "' " +
                    (r.shortcut ? " data-shortcut='" + r.shortcut + "' " : "") +
                    ">"),
                  ...
                  e.vakata.context.settings.icons &&
                    ...
                    r.icon &&
                      (a +=
                        -1 !== r.icon.indexOf("/") || -1 !== r.icon.indexOf(".")
                          ? " style='background:url(\"" + r.icon + "\") center center no-repeat' "
                          : " class='" + r.icon + "' "),
                    (a += "></i><span class='vakata-contextmenu-sep'>&#160;</span>")),
                  (a +=
                    (e.isFunction(r.label)
                      ? r.label({
                          item: t,
                          reference: i.reference,
                          element: i.element,
                    ...
                    (r.shortcut
                      ...
                      : "") +
                    "</a>"),
                  r.submenu && ((s = e.vakata.context._parse(r.submenu, !0)), s && (a += s)),
                  (a += "</li>"),
                  void (
                    r.separator_after &&
                    ((a +=
              ...
              r && (a += "</ul>"),
              r || ((i.html = a), e.vakata.context._trigger("parse")),
              a.length > 10 && a
            );
          },
          _show_submenu: function (i) {
            if (((i = e(i)), i.length && i.children("ul").length)) {
              ...
              t
                ? i[a - (o + 10 + i.outerWidth()) < 0 ? "addClass" : "removeClass"]("vakata-context-left")
                : i[a + o > c && s > c - a ? "addClass" : "removeClass"]("vakata-context-right"),
                n + d + 10 > l && r.css("bottom", "-1px"),
                i.hasClass("vakata-context-right") ? o > s && r.css("margin-right", s - o) : o > c - a && r.css("margin-left", c - a - o),
                r.show();
            }
          },
          show: function (r, s, a) {
            var n,
              ...
              g,
              f = !0;
            switch ((i.element && i.element.length && i.element.width(""), f)) {
              case !s && !r:
                return !1;
              case !!s && !!r:
                ...
                break;
              case !s && !!r:
                (i.reference = r), (n = r.offset()), (i.position_x = n.left + r.outerHeight()), (i.position_y = n.top);
                break;
              case !!s && !r:
            ...
            r && !a && e(r).data("vakata_contextmenu") && (a = e(r).data("vakata_contextmenu")),
              ...
              i.items.length &&
                ...
                t && ((c -= o.outerWidth() - e(r).outerWidth()), c < e(window).scrollLeft() + 20 && (c = e(window).scrollLeft() + 20)),
                c + h + 20 > u && (c = u - (h + 20)),
                l + _ + 20 > g && (l = g - (_ + 20)),
                i.element.css({ left: c, top: l }).show().find("a").first().focus().parent().addClass("vakata-context-hover"),
                (i.is_visible = !0),
                e.vakata.context._trigger("show"));
          },
          hide: function () {
            i.is_visible &&
              (i.element.hide().find("ul").hide().end().find(":focus").blur().end().detach(), (i.is_visible = !1), e.vakata.context._trigger("hide"));
          },
        }),
          e(function () {
            ...
            (i.element = e("<ul class='vakata-context'></ul>")),
              i.element
                ...
                .on("click", "a", function (t) {
                  t.preventDefault(),
                    e(this).blur().parent().hasClass("vakata-context-disabled") ||
                      !1 === e.vakata.context._execute(e(this).attr("rel")) ||
                      e.vakata.context.hide();
                })
                    ...
                    case 38:
                      i.is_visible &&
                        ((r = i.element
                          ...
                          .first()),
                        r.length || (r = i.element.find("ul:visible").addBack().last().children("li:not(.vakata-context-separator)").last()),
                        r.addClass("vakata-context-hover").children("a").focus(),
                        t.stopImmediatePropagation(),
                        t.preventDefault());
                      break;
                    case 39:
                    ...
                    case 40:
                      i.is_visible &&
                        ((r = i.element
                          ...
                          .first()),
                        r.length || (r = i.element.find("ul:visible").addBack().last().children("li:not(.vakata-context-separator)").first()),
                        r.addClass("vakata-context-hover").children("a").focus(),
                        t.stopImmediatePropagation(),
                        t.preventDefault());
                      break;
      ...
      (e.jstree.plugins.dnd = function (t, i) {
        (this.init = function (e, t) {
            ...
            i.bind.call(this),
              this.element.on(
                ...
                e.proxy(function (t) {
                  ...
                  if (
                    ...
                    (!this.settings.dnd.touch ||
                      ("selected" === this.settings.dnd.touch &&
                        !e(t.currentTarget).closest(".jstree-node").children(".jstree-anchor").hasClass("jstree-clicked")))
                  )
                    return !0;
                  ...
                  if (
                    (this.settings.core.force_text && (s = e.vakata.html.escape(s)),
                    i &&
                      i.id &&
                      i.id !== e.jstree.root &&
                      (1 === t.which || "touchstart" === t.type || "dragstart" === t.type) &&
                      (!0 === this.settings.dnd.is_draggable ||
                        (e.isFunction(this.settings.dnd.is_draggable) &&
                          this.settings.dnd.is_draggable.call(this, r > 1 ? this.get_top_selected(!0) : [i], t))))
                  ) {
                    if (
                      ((h = {
                        jstree: !0,
          ...
          (this.redraw_node = function (e, t, r, s) {
            if (((e = i.redraw_node.apply(this, arguments)), e && this.settings.dnd.use_html5))
              if (this.settings.dnd.large_drag_target) e.setAttribute("draggable", !0);
              else {
                var a,
                  n,
                  o = null;
                for (a = 0, n = e.childNodes.length; n > a; a++)
      ...
      e(function () {
        ...
        e(d)
          ...
          .on("dnd_start.vakata.jstree", function (e, t) {
            (i = !1), (s = !1), t && t.data && t.data.jstree && n.appendTo(d.body);
          })
          .on("dnd_move.vakata.jstree", function (o, d) {
            var c = d.event.target !== s.target;
            if (
              (a && (!d.event || "dragover" !== d.event.type || c) && clearTimeout(a),
              ...
              var l,
                ...
                C,
                A,
                N = e.jstree.reference(d.event.target),
                T = !1,
                O = !1,
                S = !1;
              if (N && N._data && N._data.dnd)
                if (
                  (n.attr("class", "jstree-" + N.get_theme() + (N.settings.core.themes.responsive ? " jstree-dnd-responsive" : "")),
                  (w =
                    d.data.origin &&
                    (d.data.origin.settings.dnd.always_copy || (d.data.origin.settings.dnd.copy && (d.event.metaKey || d.event.ctrlKey)))),
                  d.helper
                    .children()
                    .attr(
                      "class",
                      "jstree-" +
                        ...
                        N.get_theme_variant() +
                        " " +
                        (N.settings.core.themes.responsive ? " jstree-dnd-responsive" : ""),
                    )
                    .find(".jstree-copy")
                    .first()
                    [w ? "show" : "hide"](),
                  (d.event.target !== N.element[0] && d.event.target !== N.get_container_ul()[0]) || 0 !== N.get_container_ul().children().length)
                ) {
                  if (
                    ((T = N.settings.dnd.large_drop_target
                      ? e(d.event.target).closest(".jstree-node").children(".jstree-anchor")
                      : e(d.event.target).closest(".jstree-anchor")),
                    T &&
                      T.length &&
                      T.parent().is(".jstree-closed, .jstree-open, .jstree-leaf") &&
                      ((O = T.offset()),
                      (S = (d.event.pageY !== t ? d.event.pageY : d.event.originalEvent.pageY) - O.top),
                      (_ = T.outerHeight()),
                      (f = _ / 3 > S ? ["b", "i", "a"] : S > _ - _ / 3 ? ["a", "i", "b"] : S > _ / 2 ? ["i", "a", "b"] : ["i", "b", "a"]),
                      e.each(f, function (t, s) {
                        switch (s) {
                          case "b":
                            (l = O.left - 6), (h = O.top), (u = N.get_parent(T)), (g = T.parent().index()), (A = "jstree-below");
                            break;
                          case "i":
                            (x = N.settings.dnd.inside_pos),
                              (b = N.get_node(T.parent())),
                              (l = O.left - 2),
                              (h = O.top + _ / 2 + 1),
                              (u = b.id),
                              (g = "first" === x ? 0 : "last" === x ? b.children.length : Math.min(x, b.children.length)),
                              (A = "jstree-inside");
                            break;
                          case "a":
                            (l = O.left - 6), (h = O.top + _), (u = N.get_parent(T)), (g = T.parent().index() + 1), (A = "jstree-above");
                        }
                        for (p = !0, m = 0, v = d.data.nodes.length; v > m; m++)
                          if (
                            ((j =
                              d.data.origin &&
                              (d.data.origin.settings.dnd.always_copy || (d.data.origin.settings.dnd.copy && (d.event.metaKey || d.event.ctrlKey)))
                            ...
                            "move_node" === j &&
                              ...
                              d.data.origin &&
                              d.data.origin === N &&
                              u === N.get_parent(d.data.nodes[m]) &&
                              ((k = N.get_node(u)), y > e.inArray(d.data.nodes[m], k.children) && (y -= 1)),
                            (p =
                              p &&
                              ((N && N.settings && N.settings.dnd && !1 === N.settings.dnd.check_while_dragging) ||
                                N.check(j, d.data.origin && d.data.origin !== N ? d.data.origin.get_node(d.data.nodes[m]) : d.data.nodes[m], u, y, {
                                  dnd: !0,
                                  ref: N.get_node(T.parent()),
                                  pos: s,
                        ...
                        return (
                          "i" === s &&
                            T.parent().is(".jstree-closed") &&
                            N.settings.dnd.open_timeout &&
                            (!d.event || "dragover" !== d.event.type || c) &&
                            (a && clearTimeout(a),
                            (a = setTimeout(
                              (function (e, t) {
                                return function () {
                          ...
                          p
                            ? ((C = N.get_node(u, !0)),
                              C.hasClass(".jstree-dnd-parent") ||
                                (e(".jstree-dnd-parent").removeClass("jstree-dnd-parent"), C.addClass("jstree-dnd-parent")),
                              (i = {
                                ins: N,
                                par: u,
                                pos: "i" !== s || "last" !== x || 0 !== g || N.is_loaded(b) ? g : "last",
                              }),
                              n
                                .css({
                                  left: l + "px",
                                ...
                                .show(),
                              n.removeClass("jstree-above jstree-inside jstree-below").addClass(A),
                              ...
                              d.event.originalEvent &&
                                ...
                                (d.event.originalEvent.dataTransfer.dropEffect = w ? "copy" : "move"),
                              (r = {}),
                              (f = !0),
                              !1)
                            : void 0
                    ...
                    ((p =
                      ...
                      N.check(
                        d.data.origin &&
                          ...
                          ? "copy_node"
                          : "move_node",
                        d.data.origin && d.data.origin !== N ? d.data.origin.get_node(d.data.nodes[m]) : d.data.nodes[m],
                        e.jstree.root,
                        "last",
                        {
                          dnd: !0,
          ...
          .on("dnd_scroll.vakata.jstree", function (e, t) {
            t &&
              t.data &&
              t.data.jstree &&
              (n.hide(), (i = !1), (s = !1), t.helper.find(".jstree-icon").first().removeClass("jstree-ok").addClass("jstree-er"));
          })
          .on("dnd_stop.vakata.jstree", function (t, o) {
            if ((e(".jstree-dnd-parent").removeClass("jstree-dnd-parent"), a && clearTimeout(a), o && o.data && o.data.jstree)) {
              n.hide().detach();
              var d,
                c,
                l = [];
              if (i) {
                ...
                i.ins[
                  o.data.origin &&
                  (o.data.origin.settings.dnd.always_copy || (o.data.origin.settings.dnd.copy && (o.event.metaKey || o.event.ctrlKey)))
                    ? "copy_node"
                    : "move_node"
                ](l, i.par, i.pos, !1, !1, !1, o.data.origin);
              } else
                (d = e(o.event.target).closest(".jstree")),
                  d.length && r && r.error && "check" === r.error && ((d = d.jstree(!0)), d && d.settings.core.error.call(this, r));
              (s = !1), (i = !1);
            }
          })
            ...
            (o = e.vakata.dnd._get()),
              o &&
                ...
                ("keyup" === t.type && 27 === t.which
                  ? (a && clearTimeout(a), (i = !1), (r = !1), (s = !1), (a = !1), n.hide().detach(), e.vakata.dnd._clean())
                  : (o.helper
                      .find(".jstree-copy")
                      .first()
                      [
                        o.data.origin && (o.data.origin.settings.dnd.always_copy || (o.data.origin.settings.dnd.copy && (t.metaKey || t.ctrlKey)))
                          ? "show"
                          : "hide"
                      ](),
                    s && ((s.metaKey = t.metaKey), (s.ctrlKey = t.ctrlKey), e.vakata.dnd._trigger("move", s))));
          });
      }),
      (function (e) {
        e.vakata.html = {
        ...
        e.vakata.dnd = {
          ...
          _clean: function () {
            i.helper && i.helper.remove(),
              i.scroll_i && (clearInterval(i.scroll_i), (i.scroll_i = !1)),
              (i = {
                element: !1,
                target: !1,
                is_down: !1,
          ...
          start: function (t, r, s) {
            "touchstart" === t.type &&
              ...
              (t.target = d.elementFromPoint(
                t.originalEvent.changedTouches[0].pageX - window.pageXOffset,
                t.originalEvent.changedTouches[0].pageY - window.pageYOffset,
              ))),
            ...
            try {
              (t.currentTarget.unselectable = "on"),
                ...
                t.currentTarget.style &&
                  ((t.currentTarget.style.touchAction = "none"),
            ...
            return (
              ...
              !1 !== s &&
                (i.helper = e("<div id='vakata-dnd'></div>").html(s).css({
                  display: "block",
                  margin: "0",
                  padding: "0",
                  position: "absolute",
          ...
          drag: function (t) {
            if (
              ...
              if (!i.is_drag) {
                if (
                  !(
                    Math.abs(t.pageX - i.init_x) > (i.is_touch ? e.vakata.dnd.settings.threshold_touch : e.vakata.dnd.settings.threshold) ||
                    Math.abs(t.pageY - i.init_y) > (i.is_touch ? e.vakata.dnd.settings.threshold_touch : e.vakata.dnd.settings.threshold)
                  )
                )
                  return;
                i.helper && (i.helper.appendTo(d.body), (i.helper_w = i.helper.outerWidth())),
                  (i.is_drag = !0),
              ...
              return (
                ...
                (i.scroll_l = 0),
                (i.scroll_e = !1),
                e(e(t.target).parentsUntil("body").addBack().get().reverse())
                  .filter(function () {
                    return (
                      /^auto|scroll$/.test(e(this).css("overflow")) && (this.scrollHeight > this.offsetHeight || this.scrollWidth > this.offsetWidth)
                    );
                  })
                  .each(function () {
                    var r = e(this),
                    ...
                    return (
                      this.scrollHeight > this.offsetHeight &&
                        (s.top + r.height() - t.pageY < e.vakata.dnd.settings.scroll_proximity && (i.scroll_t = 1),
                        t.pageY - s.top < e.vakata.dnd.settings.scroll_proximity && (i.scroll_t = -1)),
                      this.scrollWidth > this.offsetWidth &&
                        (s.left + r.width() - t.pageX < e.vakata.dnd.settings.scroll_proximity && (i.scroll_l = 1),
                        t.pageX - s.left < e.vakata.dnd.settings.scroll_proximity && (i.scroll_l = -1)),
                      i.scroll_t || i.scroll_l ? ((i.scroll_e = e(this)), !1) : void 0
                    );
                  }),
                i.scroll_e ||
                  ((r = e(d)),
                ...
                i.helper &&
                  ((_ = parseInt(t.pageY + e.vakata.dnd.settings.helper_top, 10)),
          ...
          stop: function (t) {
            if (
              ...
              t.target !== i.target && e(i.target).off("click.vakata"), e.vakata.dnd._trigger("stop", t);
        ...
        (this.init = function (e, t) {
          ...
          (this._load_nodes = function (t, r, s, a) {
            ...
            if (!s) {
              for (n = 0, o = t.length; o > n; n++)
                (!h[t[n]] || (!h[t[n]].state.loaded && !h[t[n]].state.failed) || a) &&
                  (l.push(t[n]), (d = this.get_node(t[n], !0)), d && d.length && d.addClass("jstree-loading").attr("aria-busy", !0));
              if (((this._data.massload = {}), l.length)) {
                if (e.isFunction(c))
                  return c.call(
                    ...
                    e.proxy(function (e) {
                      ...
                      for (n = 0, o = t.length; o > n; n++)
                        (d = this.get_node(t[n], !0)), d && d.length && d.removeClass("jstree-loading").attr("aria-busy", !1);
                ...
                if ("object" == typeof c && c && c.url)
                  return (
                    (c = e.extend(!0, {}, c)),
                    e.isFunction(c.url) && (c.url = c.url.call(this, l)),
                    e.isFunction(c.data) && (c.data = c.data.call(this, l)),
                    e
                      .ajax(c)
                      .done(
                        e.proxy(function (e, n, o) {
                          var c, l;
                          if (e) for (c in e) e.hasOwnProperty(c) && (this._data.massload[c] = e[c]);
                          for (c = 0, l = t.length; l > c; c++)
                            (d = this.get_node(t[c], !0)), d && d.length && d.removeClass("jstree-loading").attr("aria-busy", !1);
                          i._load_nodes.call(this, t, r, s, a);
                        }, this),
                      )
                      .fail(
          ...
          (this._load_node = function (t, r) {
            var s,
              ...
              n = null;
            return a
              ? ((n = this["string" == typeof a ? "_append_html_data" : "_append_json_data"](
                  t,
                  "string" == typeof a
                ...
                s && s.length && s.removeClass("jstree-loading").attr("aria-busy", !1),
      ...
      (e.jstree.plugins.search = function (i, r) {
        (this.bind = function () {
          ...
          (this.search = function (i, r, s, a, n, o) {
            if (!1 === i || "" === e.vakata.trim(i.toString())) return this.clear_search();
            (a = this.get_node(a)), (a = a && a.id ? a.id : null), (i = i.toString());
            var d,
              c,
              ...
              f = [];
            if (
              (this._data.search.res.length && !n && this.clear_search(),
            ...
            if (
              ...
              e.each(_[a || e.jstree.root].children_d, function (e, t) {
                ...
                r.text &&
                  !r.state.hidden &&
                  (!l.search_leaves_only || (r.state.loaded && 0 === r.children.length)) &&
                  ((l.search_callback && l.search_callback.call(this, i, r)) || (!l.search_callback && u.search(r.text).isMatch)) &&
                  (g.push(t), (f = f.concat(r.parents)));
              }),
              g.length)
            ) {
              for (f = e.vakata.array_unique(f), d = 0, c = f.length; c > d; d++)
              ...
              n
                ? ((this._data.search.dom = this._data.search.dom.add(
                    e(
                      this.element[0].querySelectorAll(
                        "#" +
                          e
                            .map(g, function (t) {
                              return -1 !== "0123456789".indexOf(t[0])
                                ? "\\3" + t[0] + " " + t.substr(1).replace(e.jstree.idregex, "\\$&")
                  ...
                  (this._data.search.res = e.vakata.array_unique(this._data.search.res.concat(g))))
                : ((this._data.search.dom = e(
                    this.element[0].querySelectorAll(
                      "#" +
                        e
              ...
              this._data.search.res.length &&
                ((this._data.search.dom = e(
                  this.element[0].querySelectorAll(
                    "#" +
                      e
                        .map(this._data.search.res, function (t) {
                          return -1 !== "0123456789".indexOf(t[0])
                            ? "\\3" + t[0] + " " + t.substr(1).replace(e.jstree.idregex, "\\$&")
                            : t.replace(e.jstree.idregex, "\\$&");
                        })
      ...
      (function (e) {
        (e.vakata.search = function (t, i, r) {
          ...
          return (
            ...
            (o = function (e) {
              if (((e = r.caseSensitive ? e : e.toLowerCase()), t === e || -1 !== e.indexOf(t))) return { isMatch: !0, score: 0 };
              ...
              var i,
                ...
                b = [];
              for (
                -1 !== y && ((j = Math.min(n(0, y), j)), (y = e.lastIndexOf(t, d + h)), -1 !== y && (j = Math.min(n(0, y), j))), y = -1, i = 0;
                h > i;
                i++
              ) {
                for (c = 0, _ = k; _ > c; ) n(i, d + _) <= j ? (c = _) : (k = _), (_ = Math.floor((k - c) / 2 + c));
                for (k = _, g = Math.max(1, d - _ + 1), f = Math.min(d + _, v) + h, p = new Array(f + 2), p[f + 1] = (1 << i) - 1, o = f; o >= g; o--)
                  if (
                    ((m = a[e.charAt(o - 1)]),
        ...
        (this.bind = function () {
          ...
          (this.sort = function (t, i) {
            ...
            if (((t = this.get_node(t)), t && t.children && t.children.length && (t.children.sort(e.proxy(this.settings.sort, this)), i)))
              for (r = 0, s = t.children_d.length; s > r; r++) this.sort(t.children_d[r], !1);
          });
      });
    var g = !1;
      ...
      (e.jstree.plugins.state = function (t, i) {
        (this.bind = function () {
          ...
          (this.restore_state = function () {
            ...
            return (
              !(t && t.ttl && t.sec && +new Date() - t.sec > t.ttl) &&
              (t && t.state && (t = t.state),
        ...
        (this.init = function (i, s) {
          ...
          if (s && s.types && s.types.default)
            for (a in s.types)
              if ("default" !== a && a !== e.jstree.root && s.types.hasOwnProperty(a))
                for (n in s.types.default) s.types.default.hasOwnProperty(n) && s.types[a][n] === t && (s.types[a][n] = s.types.default[n]);
                  ...
                  if (
                    ...
                    for (n in c[l].li_attr)
                      if (c[l].li_attr.hasOwnProperty(n)) {
                        if ("id" === n) continue;
                        o[d[s]].li_attr[n] === t
                          ? (o[d[s]].li_attr[n] = c[l].li_attr[n])
                          : "class" === n && (o[d[s]].li_attr.class = c[l].li_attr.class + " " + o[d[s]].li_attr.class);
                      }
                  if (c[l].a_attr !== t && "object" == typeof c[l].a_attr)
                    for (n in c[l].a_attr)
                      if (c[l].a_attr.hasOwnProperty(n)) {
                        if ("id" === n) continue;
                        o[d[s]].a_attr[n] === t
                          ? (o[d[s]].a_attr[n] = c[l].a_attr[n])
                          : "href" === n && "#" === o[d[s]].a_attr[n]
                            ? (o[d[s]].a_attr.href = c[l].a_attr.href)
                            : "class" === n && (o[d[s]].a_attr.class = c[l].a_attr.class + " " + o[d[s]].a_attr.class);
                      }
                }
          ...
          (this.get_json = function (t, i, s) {
            ...
            if (e.isArray(c))
              for (a = 0, n = c.length; n > a; a++)
                (c[a].type = c[a].id && o[c[a].id] && o[c[a].id].type ? o[c[a].id].type : "default"),
                  i &&
                    i.no_id &&
                    (delete c[a].id,
          ...
          (this.check = function (i, s, a, n, o) {
            ...
            var d,
              ...
              l,
              h,
              _ = s && s.id ? (o && o.origin ? o.origin : e.jstree.reference(s.id)) : null;
            switch (((_ = _ && _._model && _._model.data ? _._model.data : null), i)) {
              case "create_node":
              case "move_node":
              case "copy_node":
                if ("move_node" !== i || -1 === e.inArray(s.id, a.children)) {
                  if (((d = this.get_rules(a)), d.max_children !== t && -1 !== d.max_children && d.max_children === a.children.length))
                    return (
                      (this._data.core.last_error = {
                        error: "check",
                        plugin: "types",
                  ...
                  do {
                    ...
                    (a = this.get_node(a.parent)), (d = this.get_rules(a)), c++;
                  } while (a);
                }
            }
            return !0;
          ...
          (this.get_type = function (t, i) {
            return (t = this.get_node(t)), !!t && (i ? e.extend({ type: t.type }, this.settings.types[t.type]) : t.type);
          }),
          (this.set_type = function (i, r) {
            var s,
              ...
              _ = this._model.data;
            if (e.isArray(i)) {
              for (i = i.slice(), a = 0, n = i.length; n > a; a++) this.set_type(i[a], r);
              return !0;
            }
            if (((s = this.settings.types), (i = this.get_node(i)), !s[r] || !i)) return !1;
            if (
              ((l = this.get_node(i, !0)),
              l && l.length && (h = l.children(".jstree-anchor")),
              (o = i.type),
              (d = this.get_icon(i)),
              (i.type = r),
              ...
              for (c in s[o].li_attr)
                if (s[o].li_attr.hasOwnProperty(c)) {
                  if ("id" === c) continue;
                  "class" === c
                    ? ((_[i.id].li_attr.class = (_[i.id].li_attr.class || "").replace(s[o].li_attr[c], "")), l && l.removeClass(s[o].li_attr[c]))
                    : _[i.id].li_attr[c] === s[o].li_attr[c] && ((_[i.id].li_attr[c] = null), l && l.removeAttr(c));
                }
            if (s[o] && s[o].a_attr !== t && "object" == typeof s[o].a_attr)
              for (c in s[o].a_attr)
                if (s[o].a_attr.hasOwnProperty(c)) {
                  if ("id" === c) continue;
                  "class" === c
                    ? ((_[i.id].a_attr.class = (_[i.id].a_attr.class || "").replace(s[o].a_attr[c], "")), h && h.removeClass(s[o].a_attr[c]))
                    : _[i.id].a_attr[c] === s[o].a_attr[c] &&
                      ("href" === c ? ((_[i.id].a_attr[c] = "#"), h && h.attr("href", "#")) : (delete _[i.id].a_attr[c], h && h.removeAttr(c)));
                }
            if (s[r].li_attr !== t && "object" == typeof s[r].li_attr)
              for (c in s[r].li_attr)
                if (s[r].li_attr.hasOwnProperty(c)) {
                  if ("id" === c) continue;
                  _[i.id].li_attr[c] === t
                    ? ((_[i.id].li_attr[c] = s[r].li_attr[c]), l && ("class" === c ? l.addClass(s[r].li_attr[c]) : l.attr(c, s[r].li_attr[c])))
                    : "class" === c && ((_[i.id].li_attr.class = s[r].li_attr[c] + " " + _[i.id].li_attr.class), l && l.addClass(s[r].li_attr[c]));
                }
            if (s[r].a_attr !== t && "object" == typeof s[r].a_attr)
              for (c in s[r].a_attr)
                if (s[r].a_attr.hasOwnProperty(c)) {
                  if ("id" === c) continue;
                  _[i.id].a_attr[c] === t
                    ? ((_[i.id].a_attr[c] = s[r].a_attr[c]), h && ("class" === c ? h.addClass(s[r].a_attr[c]) : h.attr(c, s[r].a_attr[c])))
                    : "href" === c && "#" === _[i.id].a_attr[c]
                      ? ((_[i.id].a_attr.href = s[r].a_attr.href), h && h.attr("href", s[r].a_attr.href))
                      : "class" === c && ((_[i.id].a_attr.class = s[r].a_attr.class + " " + _[i.id].a_attr.class), h && h.addClass(s[r].a_attr[c]));
                }
            return !0;
          });
      }),
      ...
      (e.jstree.plugins.unique = function (i, r) {
        (this.check = function (t, i, s, a, n) {
          ...
          var o,
            ...
            g = this._model.data;
          for (o = 0, d = s.children.length; d > o; o++)
            (c = g[s.children[o]].text), _ || (c = c.toLowerCase()), u && (c = c.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "")), h.push(c);
          switch ((_ || (l = l.toLowerCase()), u && (l = l.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "")), t)) {
            ...
            case "move_node":
              return (
                (o = (i.parent === s.id && (!n || !n.is_multi)) || -1 === e.inArray(l, h)),
                o ||
                  (this._data.core.last_error = {
                    error: "check",
                    plugin: "unique",
          ...
          (this.create_node = function (i, s, a, n, o) {
            if (!s || s.text === t) {
              if ((null === i && (i = e.jstree.root), (i = this.get_node(i)), !i)) return r.create_node.call(this, i, s, a, n, o);
              if (((a = a === t ? "last" : a), !a.toString().match(/^(before|after)$/) && !o && !this.is_loaded(i)))
              ...
              for (c = d = this.get_string("New node"), l = [], h = 0, _ = i.children.length; _ > h; h++)
                (u = g[i.children[h]].text), f || (u = u.toLowerCase()), p && (u = u.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "")), l.push(u);
              for (h = 1, u = c, f || (u = u.toLowerCase()), p && (u = u.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "")); -1 !== e.inArray(u, l); )
                (c = m.call(this, d, ++h).toString()),
                  (u = c),
                  f || (u = u.toLowerCase()),
              ...
              .on(
                ...
                e.proxy(function (e, t) {
                  ...
                  var i,
                    r,
                    s = !1;
                  for (i = 0, r = t.selected.length; r > i; i++)
                    (s = this.get_node(t.selected[i], !0)), s && s.length && s.children(".jstree-wholerow").addClass("jstree-wholerow-clicked");
                }, this),
              )
              .on(
                "open_node.jstree",
                ...
                e.proxy(function (e, t) {
                  ("hover_node" === e.type && this.is_disabled(t.node)) ||
                    this.get_node(t.node, !0)
                      ...
                      ["hover_node" === e.type ? "addClass" : "removeClass"]("jstree-wholerow-hovered");
                }, this),
              )
              .on(
                "contextmenu.jstree",
      ...
      p.createdCallback = function () {
        ...
        for (t in e.jstree.plugins)
          e.jstree.plugins.hasOwnProperty(t) &&
            this.attributes[t] &&
            (i.plugins.push(t), this.getAttribute(t) && JSON.parse(this.getAttribute(t)) && (i[t] = JSON.parse(this.getAttribute(t))));
