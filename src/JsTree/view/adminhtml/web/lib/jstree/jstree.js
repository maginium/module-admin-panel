  ...
  $.jstree.core.prototype = {
    ...
    init: function (el, options) {
      ...
      this.element.html(
        "<" +
          ...
          "li id='j" +
          this._id +
          "_loading' class='jstree-initial-node jstree-loading jstree-leaf jstree-last' role='none'><i class='jstree-icon jstree-ocl'></i><" +
          "a class='jstree-anchor' role='treeitem' href='#'><i class='jstree-icon jstree-themeicon-hidden'></i>" +
    ...
    get_node: function (obj, as_dom) {
      ...
      try {
        if (this._model.data[obj]) {
          ...
          typeof obj === "string" &&
          (dom = $("#" + obj.replace($.jstree.idregex, "\\$&"), this.element)).length &&
        ...
        return s.call(
          ...
          $.proxy(function (d) {
            if (d === false) {
              ...
              this[typeof d === "string" ? "_append_html_data" : "_append_json_data"](
                obj,
                typeof d === "string" ? $($.parseHTML(d)).filter(notTextOrCommentNode) : d,
                function (status) {
                  callback.call(this, status);
                },
              );
        ...
        : this.element[0].querySelector(
            "#" +
              ("0123456789".indexOf(obj.id[0]) !== -1
                ? "\\3" + obj.id[0] + " " + obj.id.substr(1).replace($.jstree.idregex, "\\$&")
    ...
    activate_node: function (obj, e) {
      ...
      this._data.core.last_clicked =
        this._data.core.last_clicked && this._data.core.last_clicked.id !== undefined ? this.get_node(this._data.core.last_clicked.id) : null;
      ...
      if (!skip_loading) {
        this.element.html(
          "<" +
            ...
            c +
            "' role='group'><" +
            "li class='jstree-initial-node jstree-loading jstree-leaf jstree-last' role='none' id='j" +
            this._id +
    ...
    move_node: function (obj, par, pos, callback, is_loaded, skip_redraw, origin) {
      ...
      old_pos =
        old_ins && old_ins._id && old_par && old_ins._model.data[old_par] && old_ins._model.data[old_par].children
      ...
      this.element
        ...
        .on("touchmove.vakata.jstree", function (e) {
          if (
            ...
            (Math.abs(ex - e.originalEvent.changedTouches[0].clientX) > 10 || Math.abs(ey - e.originalEvent.changedTouches[0].clientY) > 10)
          ) {
            clearTimeout(cto);
            $.vakata.context.hide();
          }
        ...
        $.each(o, function (i, val) {
          ...
          if (!sep && val.separator_before) {
            str +=
              ...
              "a href='#' " +
              ($.vakata.context.settings.icons ? "" : 'style="margin-left:0px;"') +
              ">&#160;<" +
              "/a><" +
              "/li>";
          }
          ...
          if (
            ...
            (this.settings.dnd.is_draggable === true ||
              ($.isFunction(this.settings.dnd.is_draggable) &&
                this.settings.dnd.is_draggable.call(this, mlt > 1 ? this.get_top_selected(true) : [obj], e)))
          ) {
            drg = {
              jstree: true,
              origin: this,
    ...
    $(document)
      ...
      .on("dnd_move.vakata.jstree", function (e, data) {
        ...
        if (ins && ins._data && ins._data.dnd) {
          ...
          data.helper
            ...
            .attr(
              ...
              "jstree-" +
                ...
                " " +
                (ins.settings.core.themes.responsive ? " jstree-dnd-responsive" : ""),
            )
            .find(".jstree-copy")
            .first()
            [is_copy ? "show" : "hide"]();
          ...
          if (
            (data.event.target === ins.element[0] || data.event.target === ins.get_container_ul()[0]) &&
        ...
        if (lastmv) {
          ...
          lastmv.ins[
            ...
            (data.data.origin.settings.dnd.always_copy || (data.data.origin.settings.dnd.copy && (data.event.metaKey || data.event.ctrlKey)))
              ? "copy_node"
              : "move_node"
          ](nodes, lastmv.par, lastmv.pos, false, false, false, data.data.origin);
        } else {
        ...
        if (data && data.data && data.data.jstree) {
          if (e.type === "keyup" && e.which === 27) {
            ...
            data.helper
              ...
              .first()
              [
                data.data.origin && (data.data.origin.settings.dnd.always_copy || (data.data.origin.settings.dnd.copy && (e.metaKey || e.ctrlKey)))
                  ? "show"
                  : "hide"
              ]();
            if (lastev) {
              ...
              "#" +
                $.map(r, function (v) {
                  return "0123456789".indexOf(v[0]) !== -1
                    ? "\\3" + v[0] + " " + v.substr(1).replace($.jstree.idregex, "\\$&")
        ...
        .on(
          ...
          $.proxy(function (e, data) {
            ...
            this.get_node(data.node, true)
              ...
              [e.type === "hover_node" ? "addClass" : "removeClass"]("jstree-wholerow-hovered");
          }, this),
        )
        .on(
          "contextmenu.jstree",
